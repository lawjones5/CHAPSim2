...
!==========================================================================================================
!==========================================================================================================
!> Building up the mesh mapping relation between physical domain and mesh
...
!  mode           name          role                                           !
!______________________________________________________________________________!
!> - str (in): string to indicate mapping of cell centre or nodes
!> - n (in): number of mapping points
!> - y (out): the physical coordinate array
!> - mp (out): the mapping relations for 1st and 2nd deriviatives
